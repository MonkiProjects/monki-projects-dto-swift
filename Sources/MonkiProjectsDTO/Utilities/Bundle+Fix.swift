...
// You can find it at <https://github.com/RemiBardon/xcode-preview-spm-resources-bug/blob/workaround/MySubLibrary/Sources/MySubLibrary/Bundle+Fix.swift>

public let localBundle = Bundle.fixedModule

private final class CurrentBundleFinder {}

private let packageName: String = "monki-projects-dto"
private let targetName: String = "MonkiProjectsDTO"
